...
![](images/fitzpatrick.png "alt-fig="Image of 2009 conference paper by Fitzpatrick titled Fiducial registration error and target registration error are uncorrelated. TLDR - The results show that no estimate of accuracy for a given patient that is based on goodness of fiducial fit for that patients gives any information whatever about true registration accuracy for that patient, and surgeons should stop using such measures as indicators of registration quality for patients on whom they are about to operate,""){width="640"}
